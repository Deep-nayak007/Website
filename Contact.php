...
include('Admin/dbcon.php');   
    ...
    $sql=mysqli_query($conn, "INSERT INTO `contact`( `name`, `email`, `mobilenumber`, `message`) VALUES ('$name','$email','$mob','$msg')");
    ...
    $email = $_POST["email"]; 
    $sql1 = mysqli_query($conn, "SELECT * FROM contact WHERE email='$email'");
    $query = mysqli_num_rows($sql1);
        ...
        if(mysqli_num_rows($sql1) <= 0){
            ...
            <b>Our team experts will contact you shortly, </b>
            <br>
            <b>With regrads,</b>
            <br>
...
<form method ="post" >
    <div class="banner">
        <div class="navbar">
            <a href="index.html"><img src="images/Footer Image 2.PNG" class="logo"/></a>    <!-- Navigate to same page when clicked on image-->
            <ul>
        ...
        <div class="location-box">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7527.499524149542!2d72.82080025390623!3d19.37998500000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7afa7f9ed03a3%3A0x155a79d4b0000000!2sTaruna%20Infosoft!5e0!3m2!1sen!2sin!4v1676963664459!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
            </iframe>
        </div>
        </section>
